			...
			<div class="grid-ctr">
				<div class="widget shadow-soft" style="width: 400px;height: fit-content">
					<div id="success" style="margin: 80px 0">
						...
						<div class="textcenter medium" style="font-size: 20px">Registrace proběhla úspěšně!</div>
						<div class="textcenter light" style="font-size: 20px">Nyní se prosím přihlašte.</div>
					</div>
					<div class="grid-ctr">
						<a href="login.php" class="pointer">
							<button class="pointer shadow-soft">Přejít k přihlášení</button>
						</a>
					</div>
				</div>
			</div>
